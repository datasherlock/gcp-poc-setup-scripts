...
export DATAPROC_PROPERTIES='dataproc:efm.spark.shuffle=primary-worker,dataproc:dataproc.monitoring.stackdriver.enable=true,dataproc:dataproc.logging.stackdriver.job.driver.enable=true,dataproc:dataproc.logging.stackdriver.job.yarn.container.enable=true' # comma delimited list of scripts

export MASTER_MACHINE_TYPE='n2d-standard-4'
export MASTER_BOOT_DISK_GB=100
export MASTER_LOCAL_SSD_NUM=2

export WORKER_MACHINE_TYPE='n2d-highmem-16'
export WORKER_BOOT_DISK=100
export WORKER_LOCAL_SSD_NUM=2
export WORKER_PRIMARY_CNT=4

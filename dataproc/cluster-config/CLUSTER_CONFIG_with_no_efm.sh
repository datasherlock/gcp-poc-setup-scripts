...
export MASTER_MACHINE_TYPE='n2d-standard-48'
export MASTER_BOOT_DISK_GB=100
export MASTER_LOCAL_SSD_NUM=2

export WORKER_MACHINE_TYPE='n2d-standard-48'
export WORKER_BOOT_DISK=100
export WORKER_LOCAL_SSD_NUM=2
export WORKER_PRIMARY_CNT=10
export WORKER_SECONDARY_CNT=1
export WORKER_SECONDARY_LOCAL_SSD_NUM=2